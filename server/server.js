...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CSLnIHyY.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-Dep64Ku5.js").then((n) => n.r);
...
const ROUTER_BASEPATH = "los-prototype";
const SERVER_FN_BASE = "/los-prototype/_serverFn/";
