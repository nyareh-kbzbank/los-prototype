...
import { ClipboardList, LayoutTemplate, Network, Table } from "lucide-react";
		...
		<div className="min-h-screen bg-slate-950 text-white">
            ...
            LOS
					...
					<p className="text-slate-300 text-lg leading-relaxed mb-8">
						Set up loan products, tune scorecards, and manage applications from one
						spot. Choose where you want to start below.
					</p>
